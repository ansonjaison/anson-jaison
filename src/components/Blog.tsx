    ...
    <section className="py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center">
          <button className="inline-flex items-center space-x-2 bg-transparent border-2 border-[#007f5f] text-[#007f5f] px-8 py-3 rounded-lg font-semibold hover:bg-[#007f5f] hover:text-[#0d0d0d] transition-all duration-300 group">
