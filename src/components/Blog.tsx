      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold mb-4">
            <span className="text-[#007f5f]">Blog</span> – Honest Thoughts
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          {blogPosts.map((post, index) => <article key={post.title} className="bg-[#1a1a1a] rounded-2xl p-6 border border-gray-800 hover:border-gray-700 transition-all duration-300 group hover:scale-105 cursor-pointer">
              <div className="mb-4">
                ...
                <h3 className="text-xl font-bold text-[#f5f5f5] mb-3 group-hover:text-[#f97316] transition-colors duration-300">
                  {post.title}
                </h3>
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {post.tags.map((tag, tagIndex) => <span key={tagIndex} className="px-3 py-1 bg-[#2a2a2a] text-[#aaaaaa] text-sm rounded-full border border-gray-700">
                    {tag}
                  </span>)}
              </div>

              <div className="flex items-center text-[#f97316] font-semibold group-hover:text-[#ea580c] transition-colors duration-300">
        ...
        <div className="text-center">
          <button className="inline-flex items-center space-x-2 bg-transparent border-2 border-[#f97316] text-[#f97316] px-8 py-3 rounded-lg font-semibold hover:bg-[#f97316] hover:text-[#0d0d0d] transition-all duration-300 group">
